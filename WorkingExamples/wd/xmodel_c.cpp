...
extern "C" SEXP solve_xmodel_c(SEXP timesSEXP, SEXP paramsSEXP, SEXP sens1iniSEXP, SEXP sens2iniSEXP, SEXP fixedSEXP, SEXP abstolSEXP, SEXP reltolSEXP, SEXP maxprogressSEXP, SEXP maxstepsSEXP, SEXP hiniSEXP, SEXP root_tolSEXP, SEXP maxrootSEXP, SEXP forcingTimesSEXP, SEXP forcingValuesSEXP) {
try {

  StepChecker checker(INTEGER(maxprogressSEXP)[0], INTEGER(maxstepsSEXP)[0]);

  ublas::vector<AD> x(1);
  ublas::vector<AD> full_params(3);
  ...
  fixed_events.emplace_back(FixedEvent<ublas::vector<AD>, AD>{full_params[2], 0,
    [full_params, &F](const ublas::vector<AD>& x, const AD& t){ return 1.0; },
    EventMethod::Add});
  ...
  auto IDX_sens1 = [n_out, n_sens_out](int t, int s, int v){ return t + n_out * (s + 1 * v); };
