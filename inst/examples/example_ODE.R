...
head(res$sens1[, "B", ])   # sensitivities of B(t): e.g. ∂B(t)/∂A <-> colum "A" (same label "A" for initial value, similar to deSolve logic)
res$sens2[10, "A", , ]     # second order sensitivities of A(time[10]) given as hessian matrix ∂2A(time[10])/∂p_i∂p_j
