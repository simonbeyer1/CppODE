/*
 ...
 The dense output architecture is derived from Boost.Odeint's rosenbrock4_dense_output
...
#ifndef CPPODE_ROSENBROCK4_DENSE_OUTPUT_HPP
#define CPPODE_ROSENBROCK4_DENSE_OUTPUT_HPP
...
struct has_reset_after_event : std::false_type {};
  ...
  *
  * @tparam ControlledStepper A controlled stepper (e.g., rosenbrock4_controller)
  *
  * @par Usage Example
  * @code
  * using controller_t = rosenbrock4_controller<rosenbrock4<double>>;
  * using dense_output_t = rosenbrock4_dense_output<controller_t>;
  *
 ...
 public:
   ...
   typedef typename stepper_type::value_type              time_type;  // external: value_type for API compat
    ...
    *
    * @note The controlled stepper is default-constructed.
    */
   ...
   /**
    * @brief Move-construct dense output wrapper
    */
   ...
   // Non-copyable (stepper hierarchy may contain non-copyable members)
   rosenbrock4_dense_output(const rosenbrock4_dense_output&) = delete;
   rosenbrock4_dense_output& operator=(const rosenbrock4_dense_output&) = delete;

   // Movable
   rosenbrock4_dense_output(rosenbrock4_dense_output&&) = default;
   rosenbrock4_dense_output& operator=(rosenbrock4_dense_output&&) = default;
    ...
    *
    * @throw cppode::step_adjustment_error if step size
   ...
   // --- Access to controlled stepper (for profiler / diagnostics dispatch) ---
   ...
   static constexpr int current_method_order() { return 4; }
 ...
 // ============================================================================
 template<class ControlledStepper>
 using rosenbrock4_dense_output_pi = rosenbrock4_dense_output<ControlledStepper>;

 template<class ControlledStepper>
 using rosenbrock4_dense_output_pi_ad = rosenbrock4_dense_output<ControlledStepper>;

} // namespace cppode

#endif // CPPODE_ROSENBROCK4_DENSE_OUTPUT_HPP
