/*
 ...
 Adapted for consistent usage with rosenbrok4_dense_output_fad within integrate_times_dense by Simon Beyer.
 */
...
public:
  ...
  /**
   * Reinitialization after events (fixed-time or root events).
   *
   * After an event:
