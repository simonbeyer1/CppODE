#ifndef BOOST_NUMERIC_ODEINT_STEPPER_ROSENBROCK4_CONTROLLER_AD_PI_HPP_INCLUDED
#define BOOST_NUMERIC_ODEINT_STEPPER_ROSENBROCK4_CONTROLLER_AD_PI_HPP_INCLUDED
...
class rosenbrock4_controller_ad_pi
{
public:
...
public:
      ...
      time_type& dt)
  {
    m_xerr_resizer.adjust_size(
      x_in, detail::bind(&rosenbrock4_controller_ad_pi::template resize_xerr<state_type>,
      ...
      time_type& dt)
  {
    m_xtemp_resizer.adjust_size(
      x, detail::bind(&rosenbrock4_controller_ad_pi::template resize_xtemp<state_type>,
                      detail::ref(*this), detail::_1));
...
using rosenbrock4_controller_ad_pi_val = rosenbrock4_controller_ad_pi<Stepper, false>;

// With derivatives in error control (more conservative, better sensitivity accuracy)
template<class Stepper>
using rosenbrock4_controller_ad_pi_deriv = rosenbrock4_controller_ad_pi<Stepper, true>;

} // namespace odeint
} // namespace numeric
} // namespace boost

#endif // BOOST_NUMERIC_ODEINT_STEPPER_ROSENBROCK4_CONTROLLER_AD_PI_HPP_INCLUDED
