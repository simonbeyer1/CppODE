...
For a worked example — defining an ODE system, computing sensitivities,
and plotting the results — see the [Predator–Prey
vignette](vignettes/CppODE_LotkaVolterra.Rmd).
